...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const fixed: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/treasury-bill-calculator`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE}/investing-from-abroad`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${BASE}/for-journalists`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/is-it-licensed`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/what-gets-published`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/credit-cards`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
