---
title: How to start investing in Ghana
date: 2026-09-01
...
start early. All true, and none of it answers the question someone actually
has: **I have some money — where do I put it, and what will it cost me?**

This is that answer. Every figure below comes from a document its issuer
published, and where something is not published, it says so rather than
guessing.

## First, the only number that decides everything

How much you have determines what you can reach. Not your risk appetite, not
your age — the minimum.
...
pesewas and Ayrton Drug at 42. On price alone, GH₵20 buys shares in either.

But you cannot buy a share without a broker, and no Ghanaian broker publishes a
minimum trade size or a minimum to open an account. One of the twenty-four
publishes any minimum at all. So a GH₵20 share purchase may be perfectly
possible, or it may be politely declined, and there is no way to find out
before you ask.

That uncertainty is itself the finding. Every other row in that table is a
...
That pattern repeats. The less you have, the fewer choices you get and the more
each one costs — and in the one case where the asset itself is cheap, the cost
of reaching it is not published.

## The four routes, and what each really costs

### 1. Money market and fixed income funds
...
Lending directly to the government of Ghana, for 91, 182 or 364 days.

| Tenor | Rate, August 2026 |
|---|---|
| 91-day | 5.08% |
| 182-day | 7.08% |
| **364-day** | **11.59%** |
...
**What the shares themselves have done.** The GSE Composite Index rose 172.7%
between February 2025 and July 2026, and trading volume rose 331% — prices rose
because more people were buying, which is the healthy version. Individual moves
were far wider than the index: several shares more than doubled, several did
nothing, and one went from 3 pesewas to GH₵4.75.

**One thing worth knowing before you look.** Ghanaian brokers do not specialise.
Any of the twenty-four can buy any listed share, so there is no need to find
"the right broker" for a particular company. What differs is cost, whether they
want retail clients, and how easily an account opens.
...
| | To start | Cost |
|---|---|---|
| Ghana Gold Coin, 1 oz | GH₵53,014 | 3.58% once |
| Ghana Gold Coin, ¼ oz | GH₵13,803 | 7.75% once |
| **NewGold ETF** | **GH₵462** | **0.30% a year** |

The coin's cost is a premium over the metal — you pay about 3.5% more than the
gold in it is worth, and more than double that on the smallest denomination.
The ETF charges an annual fee instead.

**Which is cheaper depends entirely on how long you hold it.** Against the
one-ounce coin, the ETF wins for twelve years. Against the quarter-ounce, for
twenty-six.

**And a warning the sellers will not give you.** Between June and August 2026,
gold rose 0.5% in dollars and the Ghana Gold Coin *fell* 3.9% in cedis. The
cedi strengthened, and a strengthening currency works against anyone holding a
...
For a fund, generally: a Ghana Card, proof of address, a bank account, and a
completed application. Most managers accept applications by email or in branch.

For shares, the same documents plus an account with a licensed dealing member,
and typically a Central Securities Depository account which the broker arranges.

For Treasury bills, your bank, or a broker.

For gold coins, an order placed through a commercial bank. Payment by bank
transfer or mobile money — cash is not accepted.
...
**Ask for the total expense ratio, not the management fee.** They are different
numbers and the second is smaller.

**Ask what the minimum is, and whether there is a minimum for topping up.** A
fund that takes GH₵20 to open may want GH₵100 each time after.

**Ask how quickly you can get money out.** Most Ghanaian funds deal daily, but
that is the fund's rule, not a guarantee about the market it invests in.

**And ask what it costs to leave.** Exit fees are rare in Ghana and not always
disclosed.

## What this guide cannot answer

**Which product suits you.** That is a personal recommendation and it needs a
licence from the Securities and Exchange Commission, which we do not have. We
compare what things cost and what they have done. Deciding which fits your
circumstances is your decision, or a licensed adviser's.
...
[Compare every fund we hold figures for](/funds) ·
[Find what fits your circumstances](/match) ·
[See what the 24 brokers do and do not publish](/brokers)
